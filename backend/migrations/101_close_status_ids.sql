-- Migration 101 (SQLite): Close-Sync gegen Status-Umbenennungen und Anlage-Opportunities haerten.
--
...
ALTER TABLE close_status_events ADD COLUMN old_status_id TEXT;
ALTER TABLE close_status_events ADD COLUMN new_status_id TEXT;
...
ALTER TABLE termine ADD COLUMN herkunft TEXT NOT NULL DEFAULT 'wechsel';
ALTER TABLE termine ADD COLUMN status_id TEXT;
