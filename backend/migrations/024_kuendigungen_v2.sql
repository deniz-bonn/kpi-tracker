...
ALTER TABLE deals_vl ADD COLUMN weitergeben_an_vertrieb TEXT;

-- Terminiert: was a meeting scheduled? (tracked in Kuendigungen page)
ALTER TABLE deals_vl ADD COLUMN terminiert INTEGER NOT NULL DEFAULT 0;

-- Internal new responsible person: either 'Vertrieb' or employee ID as string
ALTER TABLE deals_vl ADD COLUMN neuer_ap_intern TEXT;
