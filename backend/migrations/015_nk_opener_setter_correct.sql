-- Migration 015: Set opener_id and setter_id for NK deals (from Excel, definitive)
-- Supersedes migration 014 — re-parsed directly from Excel sheets
-- Braunschweig (generic team opener) stays NULL per user instruction
...
;
UPDATE deals_nk SET opener_id = 15, setter_id = 12 WHERE datum = '2026-05-04' AND monat = '2026-05' AND company_id = 1 AND COALESCE(closer_id, 0) = 12 AND kunde = 'Casa Con Property Management GmbH'
;
UPDATE deals_nk SET opener_id = 10, setter_id = 11 WHERE datum = '2026-05-05' AND monat = '2026-05' AND company_id = 1 AND COALESCE(closer_id, 0) = 9 AND kunde = 'Kampfmittelbergung Zimmermann GmbH'
;
UPDATE deals_nk SET opener_id = 15, setter_id = 15 WHERE datum = '2026-05-06' AND monat = '2026-05' AND company_id = 1 AND COALESCE(closer_id, 0) = 9 AND kunde = 'Vogg Haustechnik GmbH & Co. KG'
;
UPDATE deals_nk SET opener_id = 10, setter_id = 11 WHERE datum = '2026-05-06' AND monat = '2026-05' AND company_id = 1 AND COALESCE(closer_id, 0) = 9 AND kunde = 'Planung Hiller GmbH'
;
UPDATE deals_nk SET opener_id = 10, setter_id = 12 WHERE datum = '2026-05-06' AND monat = '2026-05' AND company_id = 1 AND COALESCE(closer_id, 0) = 12 AND kunde = 'Weilke Logistik GmbH'
;
UPDATE deals_nk SET opener_id = 15, setter_id = 15 WHERE datum = '2026-05-06' AND monat = '2026-05' AND company_id = 1 AND COALESCE(closer_id, 0) = 9 AND kunde = 'Hermanns & Kreutz GmbH & Co. KG'
;
UPDATE deals_nk SET opener_id = 10, setter_id = 11 WHERE datum = '2026-05-06' AND monat = '2026-05' AND company_id = 1 AND COALESCE(closer_id, 0) = 9 AND kunde = 'Ernst Hinze GmbH & Co. KG'
;
UPDATE deals_nk SET opener_id = 16, setter_id = 11 WHERE datum = '2026-05-07' AND monat = '2026-05' AND company_id = 1 AND COALESCE(closer_id, 0) = 9 AND kunde = 'Metal Check GmbH'
;
UPDATE deals_nk SET opener_id = 23, setter_id = 24 WHERE datum = '2026-05-08' AND monat = '2026-05' AND company_id = 1 AND COALESCE(closer_id, 0) = 9 AND kunde = 'Liveco Veranstaltungstechnik GmbH'
;
UPDATE deals_nk SET opener_id = 15, setter_id = 11 WHERE datum = '2026-05-08' AND monat = '2026-05' AND company_id = 1 AND COALESCE(closer_id, 0) = 9 AND kunde = 'Speedmaster GmbH'
;
UPDATE deals_nk SET opener_id = 10, setter_id = 11 WHERE datum = '2026-05-11' AND monat = '2026-05' AND company_id = 1 AND COALESCE(closer_id, 0) = 9 AND kunde = 'FASTER GmbH'
;
UPDATE deals_nk SET opener_id = 9, setter_id = 12 WHERE datum = '2026-05-11' AND monat = '2026-05' AND company_id = 1 AND COALESCE(closer_id, 0) = 12 AND kunde = 'Lausitzer Stahlbau Ruhland GmbH'
;
UPDATE deals_nk SET opener_id = 10, setter_id = 9 WHERE datum = '2026-05-12' AND monat = '2026-05' AND company_id = 1 AND COALESCE(closer_id, 0) = 9 AND kunde = 'T+S Helmrath Logistik GmbH'
;
UPDATE deals_nk SET opener_id = 15, setter_id = 11 WHERE datum = '2026-05-12' AND monat = '2026-05' AND company_id = 1 AND COALESCE(closer_id, 0) = 12 AND kunde = 'Spinnler Werkzeugbau GmbH'
;
UPDATE deals_nk SET opener_id = 10, setter_id = 12 WHERE datum = '2026-05-12' AND monat = '2026-05' AND company_id = 1 AND COALESCE(closer_id, 0) = 12 AND kunde = 'Kaupp + Diether GmbH'
;
UPDATE deals_nk SET opener_id = 10, setter_id = 15 WHERE datum = '2026-05-13' AND monat = '2026-05' AND company_id = 1 AND COALESCE(closer_id, 0) = 9 AND kunde = 'ESTA-Bildungswerk gemeinnützige GmbH'
;
UPDATE deals_nk SET opener_id = 16, setter_id = 11 WHERE datum = '2026-05-13' AND monat = '2026-05' AND company_id = 1 AND COALESCE(closer_id, 0) = 12 AND kunde = 'Heizung und Wasser Adolf und Eberhard Baur GmbH'
;
UPDATE deals_nk SET opener_id = 15, setter_id = 15 WHERE datum = '2026-05-13' AND monat = '2026-05' AND company_id = 1 AND COALESCE(closer_id, 0) = 12 AND kunde = 'Kirschenhofer Maschinen GmbH'
;
UPDATE deals_nk SET opener_id = 10, setter_id = 11 WHERE datum = '2026-05-13' AND monat = '2026-05' AND company_id = 1 AND COALESCE(closer_id, 0) = 11 AND kunde = 'Tüns Werbetechnik GmbH'
;
UPDATE deals_nk SET opener_id = 10, setter_id = 12 WHERE datum = '2026-05-13' AND monat = '2026-05' AND company_id = 1 AND COALESCE(closer_id, 0) = 12 AND kunde = 'VOGT NDT GmbH'
;
UPDATE deals_nk SET opener_id = 15, setter_id = 11 WHERE datum = '2026-05-15' AND monat = '2026-05' AND company_id = 1 AND COALESCE(closer_id, 0) = 12 AND kunde = 'Aufzugtechnik Süd GmbH'
;
UPDATE deals_nk SET opener_id = 23, setter_id = 24 WHERE datum = '2026-05-18' AND monat = '2026-05' AND company_id = 1 AND COALESCE(closer_id, 0) = 9 AND kunde = 'Antonics GmbH'
;
UPDATE deals_nk SET opener_id = 10, setter_id = 15 WHERE datum = '2026-05-18' AND monat = '2026-05' AND company_id = 1 AND COALESCE(closer_id, 0) = 9 AND kunde = 'Simon Glas GmbH & Co. KG'
;
UPDATE deals_nk SET opener_id = 10, setter_id = 11 WHERE datum = '2026-05-18' AND monat = '2026-05' AND company_id = 1 AND COALESCE(closer_id, 0) = 12 AND kunde = 'BFT Immobilien GmbH'
;
UPDATE deals_nk SET opener_id = 15, setter_id = 12 WHERE datum = '2026-05-18' AND monat = '2026-05' AND company_id = 1 AND COALESCE(closer_id, 0) = 12 AND kunde = 'GPI Aachen GmbH'
;
UPDATE deals_nk SET opener_id = 15, setter_id = 11 WHERE datum = '2026-05-18' AND monat = '2026-05' AND company_id = 1 AND COALESCE(closer_id, 0) = 12 AND kunde = 'Biedensand Bäder Lampertheim GmbH'
;
UPDATE deals_nk SET opener_id = 10, setter_id = 11 WHERE datum = '2026-05-18' AND monat = '2026-05' AND company_id = 1 AND COALESCE(closer_id, 0) = 12 AND kunde = 'SRG Schaltanlagen GmbH & Co. KG'
;
UPDATE deals_nk SET opener_id = 10, setter_id = 11 WHERE datum = '2026-05-18' AND monat = '2026-05' AND company_id = 1 AND COALESCE(closer_id, 0) = 9 AND kunde = 'SPS Klimatechnische Verkaufsu. Beratungs GmbH'
;
UPDATE deals_nk SET opener_id = 15, setter_id = 11 WHERE datum = '2026-05-19' AND monat = '2026-05' AND company_id = 1 AND COALESCE(closer_id, 0) = 12 AND kunde = 'Bauunternehmen Marco Friedrich GmbH'
;
UPDATE deals_nk SET opener_id = 10, setter_id = 11 WHERE datum = '2026-05-20' AND monat = '2026-05' AND company_id = 1 AND COALESCE(closer_id, 0) = 12 AND kunde = 'Meile-technik GmbH Heizung-Klima-Sanitär'
;
UPDATE deals_nk SET opener_id = 10, setter_id = 11 WHERE datum = '2026-05-20' AND monat = '2026-05' AND company_id = 1 AND COALESCE(closer_id, 0) = 9 AND kunde = 'Sunshine Wintergarten GmbH'
;
UPDATE deals_nk SET opener_id = 10, setter_id = 15 WHERE datum = '2026-05-20' AND monat = '2026-05' AND company_id = 1 AND COALESCE(closer_id, 0) = 9 AND kunde = 'PRT Rohrtechnik Berlin-Brandenburg GmbH'
;
UPDATE deals_nk SET setter_id = 11 WHERE datum = '2026-05-21' AND monat = '2026-05' AND company_id = 1 AND COALESCE(closer_id, 0) = 9 AND kunde = 'Ingenieurbüro Mayer AG'
;
UPDATE deals_nk SET opener_id = 15, setter_id = 15 WHERE datum = '2026-05-21' AND monat = '2026-05' AND company_id = 1 AND COALESCE(closer_id, 0) = 9 AND kunde = 'HERBERT Tire Tooling GmbH & Co. KG'
;
UPDATE deals_nk SET opener_id = 10, setter_id = 11 WHERE datum = '2026-05-21' AND monat = '2026-05' AND company_id = 1 AND COALESCE(closer_id, 0) = 9 AND kunde = 'ZYNP Europe GmbH'
;
UPDATE deals_nk SET opener_id = 10, setter_id = 15 WHERE datum = '2026-05-21' AND monat = '2026-05' AND company_id = 1 AND COALESCE(closer_id, 0) = 9 AND kunde = 'Gipser Schmid GmbH'
;
UPDATE deals_nk SET setter_id = 11 WHERE datum = '2026-05-22' AND monat = '2026-05' AND company_id = 1 AND COALESCE(closer_id, 0) = 9 AND kunde = 'ImmoProjekt Wohn- und Gewerbeobjekte GmbH'
;
UPDATE deals_nk SET opener_id = 10, setter_id = 12 WHERE datum = '2026-05-21' AND monat = '2026-05' AND company_id = 1 AND COALESCE(closer_id, 0) = 12 AND kunde = 'Hamann GmbH'
;
UPDATE deals_nk SET opener_id = 10, setter_id = 11 WHERE datum = '2026-05-26' AND monat = '2026-05' AND company_id = 1 AND COALESCE(closer_id, 0) = 12 AND kunde = 'Tank - Technik - Handel Meiwes GmbH'
;
UPDATE deals_nk SET opener_id = 10, setter_id = 11 WHERE datum = '2026-05-27' AND monat = '2026-05' AND company_id = 1 AND COALESCE(closer_id, 0) = 9 AND kunde = 'TE-LOH Germany GmbH'
;
UPDATE deals_nk SET opener_id = 10, setter_id = 9 WHERE datum = '2026-05-27' AND monat = '2026-05' AND company_id = 1 AND COALESCE(closer_id, 0) = 9 AND kunde = 'bash-tec GmbH'
;
UPDATE deals_nk SET setter_id = 11 WHERE datum = '2026-05-28' AND monat = '2026-05' AND company_id = 1 AND COALESCE(closer_id, 0) = 12 AND kunde = 'SBB Cargo International AG'
;
UPDATE deals_nk SET opener_id = 23, setter_id = 24 WHERE datum = '2026-05-28' AND monat = '2026-05' AND company_id = 1 AND COALESCE(closer_id, 0) = 9 AND kunde = 'hw Wenisch Haustechnik GmbH & Co. KG'
;
UPDATE deals_nk SET opener_id = 10, setter_id = 15 WHERE datum = '2026-05-28' AND monat = '2026-05' AND company_id = 1 AND COALESCE(closer_id, 0) = 9 AND kunde = 'ITALMOTO Vertriebsgesellschaft mbH'
;
UPDATE deals_nk SET opener_id = 15, setter_id = 11 WHERE datum = '2026-05-29' AND monat = '2026-05' AND company_id = 1 AND COALESCE(closer_id, 0) = 9 AND kunde = 'Gebr. Schröder Kabel- und Leitungsbau GmbH'
;
UPDATE deals_nk SET opener_id = 15, setter_id = 11 WHERE datum = '2026-05-29' AND monat = '2026-05' AND company_id = 1 AND COALESCE(closer_id, 0) = 12 AND kunde = 'IWS GmbH'
;
...
;
UPDATE deals_nk SET opener_id = 10, setter_id = 11 WHERE datum = '2026-06-01' AND monat = '2026-06' AND company_id = 1 AND COALESCE(closer_id, 0) = 9 AND kunde = 'Kulina Zerspanungstechnik und Maschinenbau GmbH'
;
UPDATE deals_nk SET opener_id = 23, setter_id = 24 WHERE datum = '2026-06-01' AND monat = '2026-06' AND company_id = 1 AND COALESCE(closer_id, 0) = 12 AND kunde = 'Jens Gottschalk GmbH'
;
UPDATE deals_nk SET opener_id = 10, setter_id = 11 WHERE datum = '2026-06-02' AND monat = '2026-06' AND company_id = 1 AND COALESCE(closer_id, 0) = 12 AND kunde = 'Schrage GmbH'
;
UPDATE deals_nk SET opener_id = 15, setter_id = 12 WHERE datum = '2026-06-02' AND monat = '2026-06' AND company_id = 1 AND COALESCE(closer_id, 0) = 12 AND kunde = 'Meusel & Beck GmbH'
;
UPDATE deals_nk SET opener_id = 15, setter_id = 11 WHERE datum = '2026-06-02' AND monat = '2026-06' AND company_id = 1 AND COALESCE(closer_id, 0) = 12 AND kunde = 'Artemis Service GmbH'
;
UPDATE deals_nk SET opener_id = 15, setter_id = 12 WHERE datum = '2026-06-02' AND monat = '2026-06' AND company_id = 1 AND COALESCE(closer_id, 0) = 12 AND kunde = 'S&P Steuerberatungsgesellschaft GmbH'
;
UPDATE deals_nk SET opener_id = 15, setter_id = 9 WHERE datum = '2026-06-05' AND monat = '2026-06' AND company_id = 1 AND COALESCE(closer_id, 0) = 9 AND kunde = 'Ohland Straßen- und Tiefbau GmbH'
;
UPDATE deals_nk SET opener_id = 10, setter_id = 12 WHERE datum = '2026-06-08' AND monat = '2026-06' AND company_id = 1 AND COALESCE(closer_id, 0) = 12 AND kunde = 'Ruhrmann GmbH & Co. KG'
;
UPDATE deals_nk SET setter_id = 12 WHERE datum = '2026-06-08' AND monat = '2026-06' AND company_id = 1 AND COALESCE(closer_id, 0) = 12 AND kunde = 'SWW Stahlbau Westerwald GmbH'
;
UPDATE deals_nk SET opener_id = 11, setter_id = 11 WHERE datum = '2026-06-08' AND monat = '2026-06' AND company_id = 1 AND COALESCE(closer_id, 0) = 9 AND kunde = 'CLIMATECH Service GmbH'
;
UPDATE deals_nk SET opener_id = 10, setter_id = 11 WHERE datum = '2026-06-08' AND monat = '2026-06' AND company_id = 1 AND COALESCE(closer_id, 0) = 12 AND kunde = 'J. Knittel Söhne Verwaltungsgesellschaft mbH'
;
UPDATE deals_nk SET opener_id = 10, setter_id = 10 WHERE datum = '2026-06-10' AND monat = '2026-06' AND company_id = 1 AND COALESCE(closer_id, 0) = 9 AND kunde = 'Claus Hansen Malereibetrieb GmbH'
;
UPDATE deals_nk SET opener_id = 10, setter_id = 12 WHERE datum = '2026-06-10' AND monat = '2026-06' AND company_id = 1 AND COALESCE(closer_id, 0) = 12 AND kunde = 'Haar Mecklenburg GmbH & Co. KG'
;
