-- Migration 100: Fundament fuer die Close-Show-Rates (Opener/Setter).
...
CREATE TABLE IF NOT EXISTS close_user_map (
  ...
  ignorieren      BOOLEAN NOT NULL DEFAULT FALSE,  -- Sammel-/Systemkonten (Cold Mail, Probe Arbeiten…)
  auto_zugeordnet BOOLEAN NOT NULL DEFAULT FALSE,  -- via users.email automatisch vorgeschlagen
