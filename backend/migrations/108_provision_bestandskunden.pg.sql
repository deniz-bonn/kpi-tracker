-- Migration 108: Abrechnungskreis "Bestandskundenvertrieb" (AM/KAM) — Postgres
--
...
--
-- HINWEIS zu Constraints: provision_zeitraeume.kreis und provision_config.kreis haben bewusst
-- KEINEN CHECK (Stand 091/094) — die Kreis-Gueltigkeit lebt in utils/kreise.js. Diese Migration
-- fuehrt deshalb auch keinen ein, um das Muster nicht auf halber Strecke zu brechen.
...
-- filtern GENAU darauf (storniereDeal: "WHERE b.deal_id=$1", Staffel-Deltas ebenso). Ohne diese
...
ALTER TABLE provision_buchungen ADD COLUMN IF NOT EXISTS deal_quelle TEXT NOT NULL DEFAULT 'nk';
...
ALTER TABLE provision_config ADD COLUMN IF NOT EXISTS upsell_satz  NUMERIC;
ALTER TABLE provision_config ADD COLUMN IF NOT EXISTS auto_vl_satz NUMERIC;
