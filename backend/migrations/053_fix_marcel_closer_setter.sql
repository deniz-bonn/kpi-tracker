...
UPDATE deals_nk SET closer_id=24, updated_at=datetime('now') WHERE closer_id=19;
UPDATE deals_nk SET setter_id=24, updated_at=datetime('now') WHERE setter_id=19;
