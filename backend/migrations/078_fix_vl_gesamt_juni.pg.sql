-- Migration 078: vl_gesamt Juni 2026 konsistent zu vl_de_ae + vl_at_ae (Postgres)
...
UPDATE ae_gesamt_monthly SET vl_gesamt = vl_de_ae + vl_at_ae, updated_at = NOW() WHERE monat = '2026-06';
