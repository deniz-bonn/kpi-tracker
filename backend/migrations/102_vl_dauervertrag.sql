-- Migration 102 (SQLite): Kennzeichnung "Verlängerung auf Dauervertrag umgestellt" + neuer AE-Wert.
--
...
ALTER TABLE deals_vl ADD COLUMN dauervertrag_umgestellt INTEGER NOT NULL DEFAULT 0;
ALTER TABLE deals_vl ADD COLUMN dauervertrag_ae_wert    NUMERIC;
ALTER TABLE deals_vl ADD COLUMN dauervertrag_datum      DATE;
